...
$EndpointName = "endpoint-gewe-dino-lab-01"
$RoutingRuleName = "route-gewe-dino-lab-01"
...
# Add an app to origin group.
New-AzFrontDoorCdnOrigin -ResourceGroupName $ResourceGroup -OriginGroupName $OriginGroupName -OriginName $OriginName -HostName $OriginHostName -OriginHostHeader $OriginHostName -ProfileName $ProfileName -HttpPort 80 -HttpsPort 443 -Priority 1 -Weight 1000
...
New-AzFrontDoorCdnRoute -ResourceGroupName $ResourceGroup -Name $RoutingRuleName -ProfileName $ProfileName -EndpointName $EndpointName -OriginGroupId $OriginGroupId -LinkToDefaultDomain Enabled -HttpsRedirect Enabled