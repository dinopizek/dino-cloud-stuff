...
$expectedResourceGroups | Where-Object { $rgCounts[$_] -gt 1 } | ForEach-Object { Write-Host "[Double Check] $_ (found $($rgCounts[$_]) times)" -ForegroundColor DarkYellow }
...
$expectedRecoveryVaults | Where-Object { $rsvCounts[$_] -gt 1 } | ForEach-Object { Write-Host "[Double Check] $_ (found $($rsvCounts[$_]) times)" -ForegroundColor DarkYellow }
...
$expectedVnets | Where-Object { $vnetCounts[$_] -gt 1 } | ForEach-Object { Write-Host "[Double Check] $_ (found $($vnetCounts[$_]) times)" -ForegroundColor DarkYellow }
...
$expectedSubnets | Where-Object { $subnetCounts[$_] -gt 1 } | ForEach-Object { Write-Host "[Double Check] $_ (found $($subnetCounts[$_]) times)" -ForegroundColor DarkYellow }
